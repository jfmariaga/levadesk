...
class PruebasAccesos extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject('Configuración de acceso ' . $this->comentario->ticket->nomenclatura)
            ->line($this->comentario->user->name . ' Realizó la configuración correspondiente al ticket ' . $this->comentario->ticket->nomenclatura)
            ->line('Comentario:')
