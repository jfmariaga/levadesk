...
class Aprobacion extends Component
{
    ...
    public function loadAprobaciones()
    {
        ...
        $funcionalQuery = $user->aprobacionesFuncionales()
        ...
        $this->aprobacionesFuncional = $funcionalQuery->get()->map(function ($aprobacion) {
            return $this->mapAprobacion($aprobacion);
        })->toArray();

        $this->aprobacionesTi = $tiQuery->get()->map(function ($aprobacion) {
            return $this->mapAprobacion($aprobacion);
        })->toArray();
