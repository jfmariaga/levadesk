            ...
            <div class="row mb-2">
                <div class="col-md-12 col-lg-12 mt-1">
                    <div class="d-flex align-items-center">
                        ...
                        <button class="btn btn-light mx-2" wire:click="loadAprobaciones()"
                            style="height:40px;">
            ...
            function llenarTabla(data, contentId) {
                ...
                return new Promise((resolve) => {
                    ...
                    for (let index = 0; index < data.length; index++) {
                        ...
                        let row = $(`<tr id="tr_${id}" class="clickable-row" data-href="aprobar?ticket_id=${id}" style="cursor: pointer;">
