<div>
    ...
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-12">
                <button id="btnFuncional" class="btn btn-primary" onclick="mostrarTablaFuncional()">Ver Aprobaciones
                    Funcionales</button>
                <button id="btnTi" class="btn btn-secondary" onclick="mostrarTablaTi()">Ver Aprobaciones TI</button>
            </div>
        </div>
